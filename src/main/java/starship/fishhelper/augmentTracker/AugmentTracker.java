    ...
    public void render(DrawContext drawContext) {
        ...
        if (ifLineNeedsShow) {
            ...
            if (lineUsageRemain > 0) {
                drawContext.drawText(textRenderer, Text.literal(String.valueOf(lineUsageRemain)), 0, 0, 0xFFFFFFFF, true);
...
//                drawContext.drawItem(line, startLeftX + blankWidth, yPos);
        ...
        if (ifUnstableOCNeedsShow) {
            ...
            if (unstableOCDuration > 0) { // activate
                ...
                drawContext.drawText(textRenderer, Text.literal(timeStr), 0, 0, 0xFF7FBEEB, true);
                matrices.set(backupMatrix);
